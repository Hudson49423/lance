...
/**
 * Created by hudson on 2/22/16.
 */
class ExtendedProjectsAdapter : RecyclerView.Adapter<ExtendedProjectsAdapter.ExtendedProjectViewHolder> {
    ...
    inner class ExtendedProjectViewHolder : RecyclerView.ViewHolder, View.OnClickListener {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup?, position: Int): ExtendedProjectViewHolder? {
        val v = LayoutInflater.from(viewGroup?.context).inflate(R.layout.project_card,
                viewGroup, false)
        val holder = ExtendedProjectViewHolder(v)
        return holder
    }

    override fun onBindViewHolder(holder: ExtendedProjectViewHolder?, i: Int) {
